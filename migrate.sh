...
# Database migration script to add description and is_featured fields to properties table

echo "Adding description and is_featured fields to properties table..."

# You can run this SQL in your Supabase dashboard SQL editor or using the CLI
...
echo "Please run the above SQL commands in your Supabase dashboard SQL editor."