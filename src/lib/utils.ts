...
export function getImageUrl(
  image: any,
  fallback = "https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?q=80&w=687&auto=format&fit=crop"
): string {
  ...
  // Upgrade HTTP to HTTPS to prevent browser mixed-content blocking in production
